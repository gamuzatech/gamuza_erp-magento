...
class Gamuza_ERP_Model_Core_Website_Api
...
protected $_additionalAttributeCodes = array ('default_group_name');

// protected $_mapAttributes = array ('website_id' => 'entity_id');
...
public function erp_items (array $filters = null)
{
    ...
    $select->join(
        ...
        'main_table.default_group_id = core_store_group.group_id',
        array ('default_group_name' => 'core_store_group.name')
    );
